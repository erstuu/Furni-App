...
<head>
    ...
    <title><?= $model["title"] ?? "FurniTuu. Register" ?></title>
                            ...
                            <div class="card-body p-4 p-lg-5 text-black">
                                ...
                                <form method="post" action="/users/register">
                                    ...
                                    <div class="d-flex align-items-center mb-2 pb-1">
                                        <p class="h1 fw-bold mb-0">Welcome!</p>
                                    </div>

                                    <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Register New User</h5>
...
<!--                                                                                                              style="color: #393f81;">Register here</a></p>-->
                                    <p class="pb-lg-2" style="color: #393f81;">Already have an account? <a href="login"
