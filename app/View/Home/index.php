...
<head>
    ...
    <title><?=  $model["title"] ?? "Furni." ?></title>
</head>
<body>
<nav class="custom-navbar navbar navbar navbar-expand-md navbar-dark bg-dark" arial-label="Furni navigation bar">

    <div class="container">
        <a class="navbar-brand" href="index.php"><?=  $model["title"] ?? "Furni." ?><span>.</span></a>
        ...
        <div class="collapse navbar-collapse" id="navbarsFurni">
            ...
            <ul class="custom-navbar-cta navbar-nav mb-2 mb-md-0 ms-5">
                <li><a class="nav-link" href="/admin"><img alt="user image" class="px-2 text-slate-900 font-bold" src="/assets/images/user.svg"> <strong>Admin</strong> </a></li>
                <li><a class="nav-link" href="cart.html"><img alt="cart image" src="/assets/images/cart.svg"></a></li>
            </ul>
        </div>
    </div>
</nav>
        ...
        <div class="row justify-content-between">
            <div class="col-lg-5">
                <div class="intro-excerpt">
                    <h1><?=  $model["slogan"] ?? "Modern Interior" ?></h1>
                    <p class="mb-4"><?=  $model["hooks"] ?? "Kenyamanan dan keindahan rumah mu adalah prioritas kami" ?></p>
                    <p><a href="/admin" class="btn btn-secondary me-2 scroll-smooth">Shop Now</a><a href="#product-section" class="btn btn-white-outline">Explore</a></p>
                </div>
            </div>
            <div class="col-lg-7">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 col-lg-3 mb-5 mb-lg-0">
                ...
                <p class="mb-4"><?=  $model["product session"] ?? "Dirancang sehingga anda dapat mendapatkan kenyamanan guna menunjang postur tubuh Anda." ?></p>
            ...
            <div class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                <a class="product-item" href="charts.php">
...
<footer class="footer-section">
    <div class="container relative">
        ...
        <div class="row g-5 mb-5">
            <div class="col-lg-4">
                <div class="mb-4 footer-logo-wrap"><a href="#" class="footer-logo"><?=  $model["title"] ?? "Furni." ?><span>.</span></a></div>
